...
![hugo](https://repo.x-cmd.io/hugo.svg?lang=zh)
...
合计: **193,889** 行代码（覆盖前 5 种语言、共 **1070** 个文件）。
...
- **Star**: 89,850 · **Fork**: 8,381 · **开放 issue**: 8,245 · **贡献者**: 852

## 累计统计

- **发布数**: 382 · **已合并 PR**: 3538 · **开放 PR**: 28 · **已关闭 issue**: 8049 · **开放 issue**: 196 · **提交数**: 9954
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/hugo.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260917.yml` · 2026-09-17T03:29:54Z._
